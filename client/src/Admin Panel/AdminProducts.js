...
>
  ...
  <div className="hidden lg:block overflow-x-auto">
    <table className="w-full border-collapse">
      <thead>
        <tr className="bg-purple-600 text-white text-sm lg:text-base">
          <th className="p-3 sticky top-0">Id</th>
          ...
          <th className="p-3">Build Date</th>
      ...
      <tbody>
        {currentRows && filteredProducts.length > 0 ? (
          filteredProducts.map((product) => (
            <tr key={product.id} className="border-b hover:bg-gray-200 text-sm lg:text-base">
              <td className="p-3">{product.id}</td>
              <td className="p-3">{product.name}</td>
              <td className="p-3">{product.category}</td>
              <td className="p-3">
                {product.image_url ? (
                  <Image width={50} src={product.image_url} className="w-12 h-12 rounded-lg shadow-sm" />
                ) : (
                  "No image"
                )}
              </td>
              ...
              <td className="p-3">{product.buildDate}</td>
              <td className="p-3">{product.expireDate}</td>
              <td className="p-3">{product.description}</td>
              <td className="p-3">{product.ingredients}</td>
              <td className="p-3">{convertToBangladeshTime(product.created_at)}</td>
              <td className="p-3 flex">
                <button
                  onClick={() => handleEdit(product)}
                  className="bg-yellow-500 text-white px-3 py-2 rounded-lg mr-2 flex items-center space-x-2"
                >
          ...
          <tr>
            <td colSpan="14" className="text-center p-6 text-gray-600 bg-gray-50 border rounded-lg shadow-sm">
  ...
  <div className="lg:hidden flex flex-col gap-4">
    {filteredProducts.length > 0 ? (
      filteredProducts.map((product) => (
        <div key={product.id} className="p-4 bg-gray-100 rounded-lg shadow-md">
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              <p className="text-gray-500 font-semibold">Stock</p>
              <p>{product.stock}</p>
            </div>
            <div>
            ...
            <div>
              <p className="text-gray-500 font-semibold">Build Date</p>
              <p>{product.buildDate}</p>
            </div>
            <div>
              <p className="text-gray-500 font-semibold">Expire Date</p>
          ...
          <div className="mt-4 flex justify-center">
            {product.image_url ? (
              <Image width={80} src={product.image_url} className="w-20 h-20 rounded-lg shadow-sm" />
            ) : (
              <p>No image</p>
            )}
          </div>
          ...
          <div className="flex justify-between mt-4">
            <button
              onClick={() => handleEdit(product)}
              className="bg-yellow-500 text-white px-3 py-2 rounded-lg flex items-center space-x-2"
            >
              <FaEdit className="text-white" />
              <span>Edit</span>
            </button>
